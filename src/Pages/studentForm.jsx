  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-[#f0f2f8] flex flex-col">
        <HeroSection />
        <div className="flex-1 max-w-2xl mx-auto w-full mt-10 px-4">
          <div className="bg-white rounded-2xl shadow-md p-10 text-center">
            ...
            <p className="text-gray-500 text-sm">
              Thank you, <span className="font-semibold text-indigo-600">{formData.fullName}</span>. Your information has been submitted. You will receive your participation certificate shortly.
            </p>
          </div>
        </div>
        <Footer />
    ...
    <div className="min-h-screen bg-[#f0f2f8] flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto w-full mt-8 mb-12 px-4">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <button
            type="submit"
            className="w-full bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 text-white font-bold text-sm rounded-xl py-4 flex items-center justify-center gap-2 transition-colors"
          >
